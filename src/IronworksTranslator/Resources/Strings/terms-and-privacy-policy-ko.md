...
1.1. 본 프로그램은 성능 및 품질 개선을 위해 프로그램의 세부적인 동작 내역을 암호화된 로그 파일 형태로 저장해둡니다.

1.2. 조항 1.1에서 수집하는 정보의 예시에는 UI(버튼, 탭 등)와의 상호작용, 설정의 변경, 채팅 내역 등이 해당됩니다. 로그 파일은 공개키 기반 암호화로 저장되며, 개발자가 보관한 개인키 없이는 내용을 확인할 수 없습니다.
...
3.1. 조항 1.1에서 명시한 암호화 로그 파일은 항상 사용자의 기기에 저장되며, 절대 개발자에게 자동으로 전송되지 않습니다.

3.2. 사용자가 개발자에게 프로그램 오류, 오동작 등을 제보했을 때에만 개발자 쪽에서 참고를 위해 암호화 로그 파일의 공유를 요청할 수 있습니다. 사용자는 로그 파일의 공유를 거부할 수 있습니다.
...
4.1. 사용자는 언제든지 프로그램 설정에서 암호화 로그 파일을 삭제할 수 있습니다.
